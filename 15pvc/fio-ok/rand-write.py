...
# import sh
# import codecs
# rmrf = subprocess.Popen("ssh root@192.168.10.2 'rm -rf *.fio' && ssh root@192.168.10.3 'rm -rf *.fio' ", shell=True, stdout=subprocess.PIPE)
...
fio_1 = subprocess.Popen("kubectl exec -it fio-1 -- fio /root/rand-write.fio > out/fio-1-rand-write.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)

fio_2 = subprocess.Popen("kubectl exec -it fio-2 -- fio /root/rand-write.fio > out/fio-2-rand-write.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)

fio_3 = subprocess.Popen("kubectl exec -it fio-3 -- fio /root/rand-write.fio > out/fio-3-rand-write.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)
...
# scp = subprocess.Popen("scp root@192.168.10.2:~/rand-write-dstat.txt /home/workspace/openebs/mayastor/15pvc/fio/out", shell=True, stdout=subprocess.PIPE)
