...
fio_1 = subprocess.Popen("kubectl exec -it fio-1 -- fio /root/seq-read.fio > out/fio-1-seq-read.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)

fio_2 = subprocess.Popen("kubectl exec -it fio-2 -- fio /root/seq-read.fio > out/fio-2-seq-read.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)

fio_3 = subprocess.Popen("kubectl exec -it fio-3 -- fio /root/seq-read.fio > out/fio-3-seq-read.fio.out 2>&1 &", shell=True, stdout=subprocess.PIPE)
...
# scp = subprocess.Popen("scp root@192.168.10.2:~/seq-read-dstat.txt /home/workspace/openebs/mayastor/15pvc/fio/out/", shell=True, stdout=subprocess.PIPE)
